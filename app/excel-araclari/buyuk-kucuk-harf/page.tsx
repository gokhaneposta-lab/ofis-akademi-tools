      ...
      >
        ...
        <section className="rounded-xl border bg-white p-4 sm:p-5" style={{ borderColor: THEME.gridLine }}>
          ...
          <p className="mt-2 text-sm text-gray-700">
            Metinleri tek tıkla büyük harf, küçük harf veya her kelimenin ilk harfi büyük biçimine çevirir. Başlık düzenleme ve veri standardizasyonunda zaman kazandırır.
          </p>
        ...
        <section className="rounded-xl border bg-white p-4 sm:p-5" style={{ borderColor: THEME.gridLine }}>
          ...
          <div className="mt-3 space-y-3 text-sm text-gray-700">
            <p><span className="font-semibold text-gray-900">Türkçe karakterler doğru dönüşür mü?</span><br />Evet, ğ ü ş ı ö ç karakterleriyle birlikte çalışır.</p>
            <p><span className="font-semibold text-gray-900">Çok satırlı metin destekleniyor mu?</span><br />Evet. Her satır aynı dönüşüm kuralına göre çevrilir.</p>
            <p><span className="font-semibold text-gray-900">Excel&apos;e geri aktarma nasıl olur?</span><br />Dönüştürdüğünüz sonucu kopyalayıp Excel&apos;e yapıştırabilirsiniz.</p>
          </div>
          <div className="mt-3 text-xs text-gray-600">
            ...
            {" · "}
            <Link href="/blog/excelde-buyuk-kucuk-harf-donusturme" className="underline" style={{ color: THEME.ribbon }}>
              rehber yazısı
            </Link>
          </div>
        </section>
