...
const NAV: NavSection[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Türkçe → Slugify", href: "/excel-araclari/turkce-slugify" },
      { label: "Veri Ayıklayıcı", href: "/excel-araclari/veri-ayikla" },
      { label: "Excel → Markdown", href: "/excel-araclari/excel-markdown" },
      { label: "Liste Birleştir / Ayır", href: "/excel-araclari/liste-birlestir" },
  ...
  },
  {
    ...
    children: [
      { label: "Tüm sınavlar", href: "/sinav" },
      { label: "TFRS 17 Deneme", href: "/sinav/tfrs-17" },
    ],
  },
  {
    label: "Blog",
