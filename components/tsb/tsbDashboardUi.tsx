...
export const tsb = {
  ...
  pageHeaderInner: "mx-auto max-w-[88rem] px-4 py-5 sm:px-6 lg:px-8",
  backLink:
  ...
  sourceNote:
    "mt-3 max-w-3xl rounded-md border border-slate-200/70 bg-slate-50/90 px-3 py-2 text-[11px] leading-relaxed text-slate-600",
  main: "mx-auto max-w-[88rem] space-y-10 px-4 py-8 sm:px-6 lg:px-8",
  dashboardStack: "space-y-8",

  stickyNavWrap:
    "sticky top-0 z-30 -mx-4 mb-2 border-b border-slate-200/80 bg-white/95 px-4 py-2 shadow-[0_1px_2px_rgba(15,23,42,0.04)] backdrop-blur-md sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8",
  stickyNavInner: "flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between",
  stickyNavGroupLabel: "text-[10px] font-semibold uppercase tracking-wider text-slate-500",
  stickyNavLinks: "flex flex-wrap gap-1",
  stickyNavLink:
    "rounded-md border border-transparent px-2.5 py-1 text-[11px] font-medium text-slate-600 transition hover:border-slate-200 hover:bg-slate-50 hover:text-slate-900",
  stickyNavLinkActive: "border-slate-300 bg-slate-100 font-semibold text-slate-900 shadow-sm",
  stickyNavHub: "shrink-0 text-[11px] font-medium text-emerald-800 hover:underline",

  filterBar:
    "rounded-lg border border-slate-200/80 bg-slate-50/60 px-3 py-2.5 shadow-[0_1px_2px_rgba(15,23,42,0.04)]",
  filterSectionLabel: "mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-slate-500",
  filterHint: "mt-2 text-[11px] leading-relaxed text-slate-600",
  filterGrid: "grid gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4",
  ...
  chartPanel:
    "overflow-x-auto rounded-xl border border-slate-200/80 bg-white p-4 shadow-[0_1px_4px_rgba(15,23,42,0.06)] sm:p-5",
...
export function TsbPageLayout({ title, description, sourceNote, currentHref, children }: TsbPageLayoutProps) {
  return (
  ...
  return (
    <nav className={tsb.stickyNavWrap} aria-label="TSB panel geçişi">
      <div className={tsb.stickyNavInner}>
        ...
        <Link href="/sigorta/tsb" className={tsb.stickyNavHub}>
          Tüm paneller →
        </Link>
      </div>
    </nav>
