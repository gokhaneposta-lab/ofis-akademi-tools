...
const LISTE_PANEL: Record<string, ListeLinkMeta> = {
  ...
  brut_prim_yoy: { path: "/sigorta/prim?panel=kanal-prim", donemFrom: "prim", segment: "hayatdisi" },
  trafik_haric_yoy: { path: "/sigorta/prim?panel=kanal-prim", donemFrom: "prim", segment: "hayatdisi" },
  ...
  pay_kazanan: { path: "/sigorta/prim?panel=brans&view=degisim", donemFrom: "prim", segment: "hayatdisi" },
  pay_kaybeden: { path: "/sigorta/prim?panel=brans&view=degisim", donemFrom: "prim", segment: "hayatdisi" },
  sira_yukselen: { path: "/sigorta/prim?panel=brans&view=sira", donemFrom: "prim", segment: "hayatdisi" },
  sira_dusen: { path: "/sigorta/prim?panel=brans&view=sira", donemFrom: "prim", segment: "hayatdisi" },
};
