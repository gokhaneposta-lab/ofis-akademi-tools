...
const LISTE_PANEL: Record<string, ListeLinkMeta> = {
  ...
  pay_kazanan: { path: "/sigorta/prim?panel=brans-degisim", donemFrom: "prim", segment: "hayatdisi" },
  pay_kaybeden: { path: "/sigorta/prim?panel=brans-degisim", donemFrom: "prim", segment: "hayatdisi" },
  sira_yukselen: { path: "/sigorta/prim?panel=brans-sira", donemFrom: "prim", segment: "hayatdisi" },
  sira_dusen: { path: "/sigorta/prim?panel=brans-sira", donemFrom: "prim", segment: "hayatdisi" },
};
